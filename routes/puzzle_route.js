...
const storage = multer.diskStorage({
    ...
    destination: function(req, file, callback) {
        callback(null, "C:/Users/fakhe/puzzlePro-backend/uploads"); // Make sure this uploads directory exists
    },
...
// router.post("/addPuzzle",upload.single("imgUrl"), puzzle_controller.uploadMiddleware,puzzle_controller.addPuzzle);
